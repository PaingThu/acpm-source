<script setup>
    ...
    import { icons } from '/src/variables.js'
    import { goto, getSheets, eventInfo } from '/src/func-common.js'

    const route = useRoute()
    console.log("roeu ", route.params.id)
    const event = ref({})
    ...
    <section class="activities">
        <div class="container py-5 px-3">
            <div class="content d-flex flex-column align-items-center gap-3 px-3 px-md-5">
                <div class="d-flex flex-column flex-md-row pb-2 align-items-center w-100 border-bottom mb-3">
